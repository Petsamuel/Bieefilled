        ...
        <>
            ...
            <section className="flex justify-between lg:py-2 pt-12 pb-6 lg:items-center ">
                ...
                <div className="flex flex-col mb-4 gap-y-1">
                    ...
                    <div className=" font-black text-3xl font-[Inter] cursor-pointer text-black"> Samuel Peters </div>
                    <div className="lg:text-md md:text-sm text-[.5em]  font-bold text-black"> <span > <a href="#" className="cursor-pointer">@Bieefilled</a> &nbsp;¤ &nbsp;Lagos, Nigeria. </span></div>
                </div>
