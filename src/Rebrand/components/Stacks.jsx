...
export const Stacks = () => {
    ...
    return (
        <div className="lg:grid lg:grid-cols-4 grid-cols-2 lg:gap-3 gap-2.5 justify-start gap-x-4 gap-y-2 hidden">{Stack.map((value, index) => (
            <div className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50" key={index}>
