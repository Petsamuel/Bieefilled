...
export const Stacks = () => {
    ...
    return (
        <div className="flex flex-wrap lg:gap-2  gap-2.5 justify-start ">{Stack.map((value, key) => (
            <div className='flex rounded-full border py-2 hover:scale-95 active:scale-90'>
                <div key={key} className="flex mx-4 cursor-pointer items-center font-['Poppins'] gap-3 ">
