export const Stepper2 = ({ handleEvent }) => {
  return (
    <ol class="flex items-center w-full p-3 space-x-2 text-sm font-medium text-center text-gray-500  border-gray-200 rounded-lg shadow-sm dark:text-gray-400 sm:text-base  dark:border-gray-700 sm:p-4 sm:space-x-4">
      <li
      ...
      >
        ...
        Education <span class="hidden sm:inline-flex sm:ml-2">Info</span>
        <svg
          aria-hidden="true"
          class="w-4 h-4 ml-2 sm:ml-4"
          fill="none"
