...
export const Modal = ({ message }) => {
  ...
  return (
    <div
      className={
        close
          ? "fixed z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)]  max-h-full grid place-content-center w-full duration-300 transform translate-y-screen scale-full origin-[0] bg-[#101010] bg-opacity-50"
          : " hidden"
      }
    >
      <div className="relative w-full max-w-md max-h-full">
        <div className="relative bg-[#242424] rounded-lg shadow-md dark:bg-[#242424]">
          <button
            onClick={() => {
              setClose(!close);
            }}
