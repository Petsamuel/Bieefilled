        ...
        {!isTextArea ? (
          <>
            ...
            <input
              type={type}
              name={name}
              className="block px-2.5 pb-2.5 pt-4 w-full text-sm bg-transparent bg-black dark:bg-black rounded-lg border-1  outline-none border shadow-sm border-gray-600 appearance-none text-white dark:text-white dark:border-gray-700 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-gray-900 peer"
              placeholder=" "
              required
              minLength="4"
              value={value}
