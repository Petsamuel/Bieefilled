        ...
        <div className="lg:pt-20 flex lg:flex-row flex-col justify-center items-center px-16">
          ...
          <div className="lg:w-2/4 dark:text-white flex-auto ">
            ...
            <div className="">
              ...
              >
                <span
                  class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-[#242424] dark:bg-[#242424] rounded-md group-hover:bg-opacity-0"
                  onClick={() => {
              ...
              >
                <span class="relative px-5 py-2.5 transition-all ease-in duration-75 bg-[#242424] dark:bg-[#242424] rounded-md group-hover:bg-opacity-0">
                  <a href="/contact">QUOTES</a>
                </span>
              </button>
            </div>
          </div>
