                    ...
                    <div className="relative grid grid-cols-1 md:grid-cols-2  gap-20">
                        ...
                        <div className="flex justify-between flex-col py-4">
                            <motion.div
                                ...
                                <h3 className="text-2xl font-bold dark:text-white text-white font-AeonikBold">
                                    {testimonials[active].name}
                                </h3>
                                <p className="text-sm text-gray-500 dark:text-neutral-500">
                                    {testimonials[active].title}
                                </p>
                                <motion.p className="text-md text-gray-500 mt-8 dark:text-neutral-300 text-left">
                                    {testimonials[active].reviews.split(" ").map((word, index) => (
                                        <motion.span
                                            key={index}
                                            initial={{
                                                filter: "blur(10px)",
                            ...
                            <div className="flex gap-4 py-[4rem] md:pt-6">
                                <button
                                    onClick={handlePrev}
